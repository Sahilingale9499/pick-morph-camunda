...
/**
 * Unit tests for {@link AEOrderTransformer}.
 * Pure static logic — no mocks, no Spring context.
 */
class AEOrderTransformerTest {
    ...
    void olStatus_created_when_expectation_zero() {
        ...
        assertEquals("created", AEOrderTransformer.computeOlStatus(srMap));
    }
    ...
    void olStatus_pending_when_partial_qty_picked() {
        ...
        assertEquals("pending", AEOrderTransformer.computeOlStatus(srMap));
    }
    ...
    void olStatus_complete_when_all_picked_and_loaded() {
        ...
        assertEquals("complete", AEOrderTransformer.computeOlStatus(srMap));
    }
    ...
    void olStatus_released_when_all_picked_and_unloaded() {
        ...
        assertEquals("released", AEOrderTransformer.computeOlStatus(srMap));
    }
    ...
    void orderStatus_created_when_null_input() {
        assertEquals("created", AEOrderTransformer.computeOrderStatus(null));
    }

    @Test
    void orderStatus_created_when_empty_input() {
        assertEquals("created", AEOrderTransformer.computeOrderStatus(Collections.emptyList()));
    }
    ...
    void orderStatus_created_when_all_created() {
        ...
        assertEquals("created", AEOrderTransformer.computeOrderStatus(statuses));
    }
    ...
    void orderStatus_pending_when_any_pending() {
        ...
        assertEquals("pending", AEOrderTransformer.computeOrderStatus(statuses));
    }
    ...
    void orderStatus_complete_when_mix_complete_released() {
        ...
        assertEquals("complete", AEOrderTransformer.computeOrderStatus(statuses));
    }
    ...
    void orderStatus_released_when_all_released() {
        ...
        assertEquals("released", AEOrderTransformer.computeOrderStatus(statuses));
    }
    ...
    void orderStatus_created_when_null_status_in_entry() {
        ...
        assertEquals("created", AEOrderTransformer.computeOrderStatus(List.of(entry)));
    }
}
