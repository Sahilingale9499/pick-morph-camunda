...
public class AeOrderBuilderService {
    ...
    private AePickListRequest.AeServiceRequestLine buildServiceRequestLine(
        ...
        AePickListRequest.AeServiceRequestLineAttributes attrs =
                AePickListRequest.AeServiceRequestLineAttributes.builder()
                        .location(location)     // null if location-service unavailable
                        .extraInfo(null)        // to be populated in future
                        .build();
    ...
    /**
     * Finds the child order_node whose order_node_id matches the given orderlineId.
    ...
    /**
     * Extracts a List<String> from a JsonNode array. Returns null if the node is missing or not an array.
     */
    ...
    /**
     * Extracts a String value from a JsonNode scalar. Returns null if missing or null.
     */
