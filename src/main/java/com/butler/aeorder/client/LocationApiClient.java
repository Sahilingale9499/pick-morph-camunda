...
public class LocationApiClient {
    ...
    /**
     * Fetches location data for the given slotId (e.g. "ToteCant4.0.A.01").
     *
     * Returns a populated AeLocation, or null if the call fails for any reason.
     * Callers must treat null as a soft error — set location to null in the payload
    ...
    /**
     * Fetches destination group for the given binId.
     * Returns the destination_group string, or null if the call fails for any reason.
     * Non-fatal: callers must set destination_group to null and continue the workflow.
     *
     * TODO: replace placeholder URL once the real endpoint is decided.
     */
