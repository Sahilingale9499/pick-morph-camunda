...
/**
 * Builds an AePickListRequest from a PickInstruction.
 *
...
public class AeOrderBuilderService {
     ...
     */
    public AePickListRequest build(PickInstruction msg) {
    ...
    private AePickListRequest buildPickListRequest(PickInstruction msg,
                                                   List<String> bintags,
    ...
    private AePickListRequest.AeExpectations buildExpectations(PickInstruction msg,
                                                               List<String> filterParams,
                                                               List<String> packageParams) {
    ...
    private AePickListRequest.AeProduct buildProduct(PickInstruction msg,
                                                     List<String> filterParams,
                                                     List<String> packageParams) {
    ...
    private AePickListRequest.AeTopLevelAttributes buildTopLevelAttributes(PickInstruction msg,
                                                                           String simplePriority,
                                                                           List<String> bintags,
                                                                           List<String> behaviours,
                                                                           String destinationGroup) {
    ...
    private AePickListRequest.AeOrderOptions buildOrderOptions(PickInstruction msg,
                                                               List<String> bintags,
                                                               List<String> behaviours,
                                                               String destinationGroup) {
